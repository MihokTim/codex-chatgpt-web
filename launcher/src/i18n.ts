...
const en = {
  ...
  browserParentTask: "Parent task",
  browserAgent: "Agent",
  browserPreparing: "Preparing",
  browserWaiting: "Waiting to send",
  browserSending: "Sending",
  browserIngesting: "Reading context",
  browserCompacting: "Compacting",
  browserGenerating: "Generating",
  browserRetained: "Retained",
  browserNextAttempt: "Next attempt",
  browserTabsOverview: "{running} running · {retained} retained. Native agents do not use browser tabs.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  browserParentTask: "主任务",
  browserAgent: "代理",
  browserPreparing: "准备中",
  browserWaiting: "等待发送",
  browserSending: "发送中",
  browserIngesting: "读取上下文",
  browserCompacting: "压缩中",
  browserGenerating: "生成中",
  browserRetained: "完成保留",
  browserNextAttempt: "下次尝试",
  browserTabsOverview: "运行中 {running} · 完成保留 {retained}。原生代理不使用浏览器标签页。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  browserParentTask: "親タスク",
  browserAgent: "担当",
  browserPreparing: "準備中",
  browserWaiting: "送信待機",
  browserSending: "送信中",
  browserIngesting: "文脈読込中",
  browserCompacting: "圧縮中",
  browserGenerating: "生成中",
  browserRetained: "完了保持",
  browserNextAttempt: "次の送信判定",
  browserTabsOverview: "稼働中 {running}・完了保持 {retained}。ネイティブ担当はブラウザーのタブを使用しません。",
...
const ko: Record<keyof typeof en, string> = {
  ...
  browserParentTask: "상위 작업",
  browserAgent: "에이전트",
  browserPreparing: "준비 중",
  browserWaiting: "전송 대기",
  browserSending: "전송 중",
  browserIngesting: "컨텍스트 읽기",
  browserCompacting: "압축 중",
  browserGenerating: "생성 중",
  browserRetained: "완료 후 보관",
  browserNextAttempt: "다음 시도",
  browserTabsOverview: "실행 중 {running} · 보관 중 {retained}. 네이티브 에이전트는 브라우저 탭을 사용하지 않습니다.",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  browserParentTask: "主工作",
  browserAgent: "代理",
  browserPreparing: "準備中",
  browserWaiting: "等待傳送",
  browserSending: "傳送中",
  browserIngesting: "讀取上下文",
  browserCompacting: "壓縮中",
  browserGenerating: "產生中",
  browserRetained: "完成保留",
  browserNextAttempt: "下次嘗試",
  browserTabsOverview: "執行中 {running} · 完成保留 {retained}。原生代理不使用瀏覽器分頁。",
