...
> **비공식 fork 빌드:** 이 브랜치는 업스트림 커밋 `212ceef`를 기준으로 한
> `MihokTim/codex-chatgpt-web` 배포판 `mihoktim-6.0.0-upstream-212ceef-20260923`입니다.
> 아래 다운로드 버튼은 계속 업스트림 v6.0.0을 가리키며 이 fork의 변경 사항을 포함하지 않습니다.
...
기존 환경 마이그레이션, Windows 실행 경로, Web Pro 하위 작업 라우팅은
[Native / Web 분리](docs/native-web-isolation.md)를 참고하세요.
